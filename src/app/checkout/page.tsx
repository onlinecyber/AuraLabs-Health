  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      const docRef = await addDoc(collection(db, "bookings"), {
        ...formData,
        package: "Comprehensive Full Body Checkup", // In a real app, this comes from a cart/context
        amount: 1499,
                      ...
                      >
                        ...
                        {formData.paymentMethod === "qr" && (
                          <div className="ml-16 sm:ml-0 bg-white p-2 rounded-xl border shadow-sm flex flex-col items-center">
                            {/* Placeholder QR - We can use a generated one or a generic icon */}
              ...
              {step === 4 && (
                ...
                >
                  ...
                  <p className="text-muted-foreground text-lg mb-8 max-w-md mx-auto relative z-10">
                    Your appointment for <span className="font-semibold text-foreground">Comprehensive Full Body Checkup</span> is confirmed for {formData.timeSlot}.
                  </p>
            ...
            <div className="lg:col-span-1">
              <div className="glass-card p-6 rounded-3xl border border-border sticky top-32">
                ...
                <div className="space-y-4 mb-6 border-b border-border pb-6">
                  <div className="flex justify-between">
                    <div>
                      <h4 className="font-semibold text-sm">Comprehensive Full Body Checkup</h4>
                      <p className="text-xs text-muted-foreground mt-1">85 Tests Included</p>
                    </div>
                ...
                <div className="flex justify-between items-end mb-6">
                  ...
                  <span className="font-bold text-3xl text-primary">₹1,499</span>
                </div>
